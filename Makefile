CFLAGS = -Wall -Wshadow -O3 -g -march=native -std=c++11
LDLIBS = -lm

all: check example1 example2 example3 example4 twoparameter1
...
twoparameter1: twoparameter1.o genann.o
	$(CXX) $(LDLIBS) $(CFLAGS) -o twoparameter1 twoparameter1.o genann.o
